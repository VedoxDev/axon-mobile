...
export default function TabLayout() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background, paddingTop: insets.top, overflow: 'hidden' }]}> 
      {/* Sidebar */}
      {showSidebar && (
        <Animated.View style={[styles.sidebar, { backgroundColor: theme.background, paddingTop: insets.top, paddingBottom: insets.bottom }, sidebarAnimStyle]}>
          ...
          {selectedProject ? (
            <>
              ...
              <Animated.View style={[projectsTitleAnimStyle, { width: '100%', alignItems: 'flex-start' }]}>
                <Text style={[styles.projectsTitle, { color: theme.text, textAlign: 'left' }]}>Tus proyectos</Text>
              </Animated.View>
      ...
      {/* Main Content */}
      <Animated.View style={[styles.content, { backgroundColor: theme.inputBackground, borderTopLeftRadius: 20, overflow: 'hidden' }, contentAnimStyle]}>
        <Tabs
          screenOptions={{
            headerShown: false,
        ...
        >
          ...
          />
          {/* Add a catch-all route for individual chats */}
          {/* This route needs to be created as app/(tabs)/chat/[id].tsx */}
          <Tabs.Screen
            name="chat/[id]"
            options={{
              title: 'Chat',
