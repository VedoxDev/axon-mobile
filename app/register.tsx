  ...
  return (
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <View style={[styles.container, { backgroundColor: theme.background }]}>
        ...
        <TextInput
          style={[styles.input, { backgroundColor: colorScheme === 'dark' ? theme.inputBackground : theme.card, color: theme.text, borderColor: correoFocused ? theme.orange : theme.gray }]}
          placeholder="Correo"
          placeholderTextColor={theme.text + "80"}
...
const styles = StyleSheet.create({
  ...
  // ... (styles from login.tsx can be reused if needed, e.g., separatorContainer, separatorLine, separatorText, googleButton, googleButtonContent, googleButtonText, joinButton, joinButtonContent, joinButtonText, etc.)
}); 